# schedule-template-electron

A minimalistic A simple template that lets you display events on a timeline, as well as organize them in groups for [Electron runtime](http://electron.atom.io). Tested on Windows, macOS and Linux.

# Quick start

Make sure you have [Node.js](https://nodejs.org) installed, then type the following commands known to every Node developer...
```
git clone https://github.com/MatheusRV/schedule-template-electron.git
cd schedule-template-electron
npm install
npm start
```
...
This project use [electron-builder](https://github.com/electron-userland/electron-builder) to handle the packaging process. It has a lot of [customization options](https://www.electron.build/configuration/configuration), which you can declare under `"build"` key in `package.json`.
